...
function getDeploymentDomain() {
  ...
  console.warn(
    'WARNING: No deployment domain found. Falling back to localhost. For production deployment, set REPLIT_INTERNAL_APP_DOMAIN, REPLIT_DEV_DOMAIN, or EXPO_PUBLIC_DOMAIN.',
  );
  return 'localhost';
}
